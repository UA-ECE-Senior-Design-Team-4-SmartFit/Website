...
echo "$First_Name $Last_Name";
 ?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="User_Profile.php"><i class="fa fa-user fa-fw"></i> <?php echo"$First_Name $Last_Name";?></a>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
<?php
$query=  "SELECT `User_FName`,`User_LName`,a.`Age`,a.`Height`,a.`Weight`,a.`Sex`,a.`Email`, `Trainer_FName`,`Trainer_LName` FROM `User_Data` a, `Trainer_Data` b WHERE a.`User_ID`=$User_ID AND( a.Trainer_ID=b.`Trainer_ID` )";
$result = mysqli_query($con,$query) or die('Query failed: ' . mysqli_error());
          ...
          ?>
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <?php echo "$First_Name's Exercies";
                          ?>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
